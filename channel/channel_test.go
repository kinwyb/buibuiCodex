...
func (m *MockChannel) Send(ctx context.Context, event *types.Event) error {
	return nil
}
func (m *MockChannel) SendStream(ctx context.Context, event *types.Event) error {
	return nil
}
func (m *MockChannel) HandleEvent(ctx context.Context, event *types.Event) error {
	return nil
}
func (m *MockChannel) HandleRequest(ctx context.Context, tp types.SyncMessageType, event *types.Event) (*types.InputMessage, error) {
	return nil, nil
}
